                    ...
                    if c_r[0] is not None and c_r[1] is not None and d_r is not None:#赤発見
                        ...
                        if 1.1 < d_r < 1.2:
                            ...
                            if elapsed_time >= 3:
                                ...
                                wav_obj = sa.WaveObject.from_wave_file("/home/yaotai/oto/men2.wav")
                                play_obj = wav_obj.play()
                                time.sleep(cstop)
                                waza=1
                                curr_time = time.time()
                        ...
                        if 1.1 < d_b < 1.2:
                            ...
                            if elapsed_time >= 3:
                                ...
                                wav_obj = sa.WaveObject.from_wave_file("/home/yaotai/oto/dou2.wav")
                                play_obj = wav_obj.play()
                                time.sleep(cstop)
                                waza=2
                                curr_time = time.time()
                        ...
                        if 1.1 < d_y < 1.2:
                            ...
                            if elapsed_time >= 3:
                                ...
                                wav_obj = sa.WaveObject.from_wave_file("/home/yaotai/oto/kote2.wav")
                                play_obj = wav_obj.play()
                                time.sleep(cstop)
                                waza=3
                                curr_time = time.time()
